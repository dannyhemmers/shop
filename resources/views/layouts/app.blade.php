...
<body>
    ...
    <nav class="navbar navbar-default navbar-static-top">
              <div class="container-fluid">
                  ...
                  <ul class="nav navbar-nav">
                          ...
                          <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Unsere fertigen Produkte<span class="caret"></span></a>
    ...
    <div class="footer">
      <a href="/impressum">Impressum</a> | <a href="#">Allgemeine Geschäftsbedingungen</a>
      <p class="muted pull-right">©ConfiDro 2017</p>
    </div>
